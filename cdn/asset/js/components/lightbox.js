...
(function (global, factory) {
    ...
    (global = typeof globalThis !== 'undefined' ? globalThis : global || self, global.oxyianUIkitLightbox = factory(global.oxyianUIkit.util));
    ...
    var LightboxPanel = {
      ...
      methods: {
        ...
        showControls() {
          ...
          uikitUtil.addClass(this.$el, 'oxyian-active', 'oxyian-transition-active');
        },

        hideControls() {
          uikitUtil.removeClass(this.$el, 'oxyian-active', 'oxyian-transition-active');
        } } };
    ...
    function install(oxyianUIkit, Lightbox) {
      if (!oxyianUIkit.lightboxPanel) {
        oxyianUIkit.component('lightboxPanel', LightboxPanel);
      }

      uikitUtil.assign(Lightbox.props, oxyianUIkit.component('lightboxPanel').options.props);
    }
    ...
    if (typeof window !== 'undefined' && window.oxyianUIkit) {
      window.oxyianUIkit.component('lightbox', Component);
    }
